...
import { index, login, register, loginFaceId } from '../controllers/authController.js'
...
router.post('/loginFaceId', loginFaceId) // login para pacientes y medicos (pendiente para administradores)
